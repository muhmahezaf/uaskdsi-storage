...
<body>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img class="first-slide" src="images/gudang.jpg" alt="First slide">
      </div>
      <div class="item">
  ...
  <footer class="footer container">
    ...
    <div class="col-lg-10 col-lg-offset-1 text-center">
      <br>
      <hr class="medium">
      <p class="text-muted" style="font-size: 16px;">Copyright &copy;<script>document.write(new Date().getFullYear());</script> | Alip Bagas I.P | Muhammad Maheza F | Zania Abuk Da Costa </p>
    </div>
  </section>
  </footer>
