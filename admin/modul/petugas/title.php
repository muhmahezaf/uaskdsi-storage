        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="table-responsive table--no-card m-b-30">
                    ...
                    ?>
                    <li class="page-item">
                        <a class="page-link" href="?m=petugas&s=awal&halaman=<?php echo $x ?>">
                        <?php echo $x; ?>
                        </a>
                    </li>
                    <?php
    ...
    <footer class="text-center">
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="text-muted" style="font-size: 16px;">Copyright &copy; <script>document.write(new Date().getFullYear());</script> Alip Bagas I.P | Muhammad Maheza F | Zania Abuk Da Costa | All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
